...
<main>
			<header class="row tm-welcome-section">
				...
				<p class="col-12 text-center">Beyond the basic purpose of restaurants to provide food and drink, restaurants have, historically, fulfilled a human need for connection and shaped social relations. In 21st century American life restaurants occupy an increasingly important place in shaping our overall economy and the nature and makeup of our cities.</p>
			</header>
			...
			<div class="tm-paging-links">
				<nav>
					...
					@foreach($categories as $key  => $category)
						<li class="tm-paging-item"><a href="" class="tm-paging-link ">{{ $category->name}}</a></li>
						@endforeach
					</ul>
				</nav>
			</div>
			...
			<div class="row tm-gallery">
				...
				<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/02.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/03.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/04.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
								<h4 class="tm-gallery-title">Aliquam sagittis</h4>
								<p class="tm-gallery-description">Nam in suscipit nisi, sit amet consectetur metus. Ut sit amet tellus accumsan</p>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/05.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/06.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/07.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/08.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
				...
				<div id="tm-gallery-page-salad" class="tm-gallery-page hidden">
					...
					<article class="col-lg-3 col-md-4 col-sm-6 col-12 tm-gallery-item">
						<figure>
							<img src="{{ asset('/')}}front/img/gallery/01.jpg" alt="Image" class="img-fluid tm-gallery-img" />
							<figcaption>
				...
				<div class="row">
					<div class="col-md-6">
						<figure class="tm-description-figure">
							<img src="{{ asset('/')}}front/img/img-01.jpg" alt="Image" class="img-fluid" />
						</figure>
					</div>
					<div class="col-md-6">
